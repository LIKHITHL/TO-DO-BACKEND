    ...
    return (
        <div className="bg-align">
            <div className="main-items">
                <h1>Todo List App </h1>
                <Link to="/addTask" className="button">Add task</Link>
